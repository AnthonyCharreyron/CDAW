<div>
    <svg id="imageContainer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="800" height="600">
        <image xlink:href="{{ asset('images/ChevaucheursDeVers-plateau.png') }}" width="800" height="600" />
        @php
