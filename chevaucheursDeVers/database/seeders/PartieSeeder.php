...
class PartieSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('partie')->insert([
            ...
            ['id_partie'=>3, 'date_partie'=>$dateNow, 'code'=> Str::random(10), 'partie_privee'=>0, 'est_commencee'=>0, 'est_terminee'=>0, 'id_user_gagnant'=>null, 'nombre_joueurs'=>3, 'temps_par_coup'=>'00:01:00', 'id_user_host'=>2]
        ]);
